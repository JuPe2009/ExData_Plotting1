...
# SET THE PARAMETER MFROW FOR THE 2 ROWS X 2 COLUMNS PLOT
par(mfrow=c(2,2))

# BUILD THE FIRST PLOT - ROW 1 COLUMN 1
with(power.consumption.data.analysis, plot(DateTime1, Global_active_power, type="l", xlab="", ylab = "Global Active Power"))

# BUILD THE SECOND PLOT - ROW 1 COLUMN 2
with(power.consumption.data.analysis, plot(DateTime1, Voltage, type="l", xlab="datetime", ylab = "Voltage"))

# BUILD THE THIRD PLOT - ROW 2 COLUMN 1
...
# BUILD THE SECOND PLOT - ROW 2 COLUMN 2
with(power.consumption.data.analysis, plot(DateTime1, Global_reactive_power, type="l", xlab="datetime"))
